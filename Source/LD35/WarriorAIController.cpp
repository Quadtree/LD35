...
void AWarriorAIController::Tick(float deltaTime)
{
	...
	else
	{
		...
		else
		{
			...
			if (UGameplayStatics::SuggestProjectileVelocity(GetPawn(), aim, launchPoint, targetPoint, 9000, false, 0.f, 0.f, ESuggestProjVelocityTraceOption::OnlyTraceWhileAsceding, FCollisionResponseParams::DefaultResponseParam, ignore))
			{
